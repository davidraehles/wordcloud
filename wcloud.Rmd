...
```{r import free text data from BigQuery}
rt <- query_exec("
                select
                text
                ,type
...
Create a function `text_wordcloud()` to turn the profile text into a word cloud.
```{r creating function to turn freetext into word cloud}
